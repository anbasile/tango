...
First, do [a quick search](https://github.com/anbasile/tango/issues) to see whether your issue has already been reported.
If your issue has already been reported, please comment on the existing issue.

Otherwise, open [a new GitHub issue](https://github.com/anbasile/tango/issues). Be sure to include a clear title
...
- Do [a quick search](https://github.com/anbasile/tango/issues) to see whether your feature has already been suggested.
...
1.  **Initial setup** (only do this once)
    ...
    At this point the local clone of your fork only knows that it came from _your_ repo, github.com/USERNAME/tango.git, but doesn't know anything the _main_ repo, [https://github.com/anbasile/tango.git](https://github.com/anbasile/tango). You can see this by running
    ...
    This means that your local clone can only track changes from your fork, but not from the main repo, and so you won't be able to keep your fork up-to-date with the main repo over time. Therefore you'll need to add another "remote" to your clone that points to [https://github.com/anbasile/tango.git](https://github.com/anbasile/tango). To do this, run the following:

        git remote add upstream https://github.com/anbasile/tango.git

    Now if you do `git remote -v` again, you'll see

        origin https://github.com/USERNAME/tango.git (fetch)
        origin https://github.com/USERNAME/tango.git (push)
        upstream https://github.com/anbasile/tango.git (fetch)
        upstream https://github.com/anbasile/tango.git (push)
...
2.  **Ensure your fork is up-to-date**
    ...
    Once you've added an "upstream" remote pointing to [https://github.com/anbasile/tango.git](https://github.com/anbasile/tango), keeping your fork up-to-date is easy:
...
4.  **Test your changes**
    ...
    We also strive to maintain high test coverage, so most contributions should include additions to [the unit tests](https://github.com/anbasile/tango/tree/main/tests). These tests are run with [`pytest`](https://docs.pytest.org/en/latest/), which you can use to locally run any test modules that you've added or changed.
    ...
    And finally, please update the [CHANGELOG](https://github.com/anbasile/tango/blob/main/CHANGELOG.md) with notes on your contribution in the "Unreleased" section at the top.

    After all of the above checks have passed, you can now open [a new GitHub pull request](https://github.com/anbasile/tango/pulls).
